...
def main():
    ...
    mc = []
    mc.insert(0, person(x-135, y-100, 0, 0, 'M',
              'left', mImg, m1Img, gameDisplay))
    mc.insert(1, person(x-90, y-100, 0, 0, 'M',
              'left', mImg, m1Img, gameDisplay))
    mc.insert(2, person(x-45, y-100, 0, 0, 'M',
              'left', mImg, m1Img, gameDisplay))
    mc.insert(3, person(x-135, y-250, 0, 0, 'C',
              'left', cImg, c1Img, gameDisplay))
    mc.insert(4, person(x-90, y-250, 0, 0, 'C',
              'left', cImg, c1Img, gameDisplay))
    mc.insert(5, person(x-45, y-250, 0, 0, 'C',
              'left', cImg, c1Img, gameDisplay))
    ...
    # indicates state of missionaries, cannibals and boat at left shore
    state = [m, c, bt]
